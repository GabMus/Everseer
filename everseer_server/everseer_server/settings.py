...
"""
Django settings for everseer_server project.
...
SECRET_KEY = 'o%x@zmnjteam^$ua!xi%#t@jn9y9pxwg@cg2xads+r=@atydo6'
...
ROOT_URLCONF = 'everseer_server.urls'
...
WSGI_APPLICATION = 'everseer_server.wsgi.application'
